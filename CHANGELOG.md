...
* Reorganized the project around one shared application core used by Home Assistant, standalone Docker, and Windows Desktop.
* Separated platform-specific configuration, packaging, storage, and integrations while keeping the main application features common across all variants.
* Added a Windows x64 Desktop version.
* Added a standalone Docker version with multiple deployment options.
* Improved application startup, diagnostics, data safety, dependency management, and automated testing.
